...
public class PersonControllerAdvice {
    ...
    public ResponseEntity<Object> handlerPersonNotFoundExceptionResponse( PersonNotFoundException personNotFoundException ){
    ...
    private ErrorResponse getPersonNotFoundExceptionResponse(PersonNotFoundException personNotFoundException,
                                                             HttpStatus httpStatus){
        return new ErrorResponse(
